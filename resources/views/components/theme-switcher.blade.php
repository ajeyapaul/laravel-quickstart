...
<div class="relative" x-data="{
    ...
    <button x-cloak class="block rounded p-1 hover:bg-gray-100 dark:hover:bg-gray-800 mr-2"
        ...
        @click="menu = !menu">
        <x-icons.sun class="block h-5 w-5 dark:hidden" />
        <x-icons.moon class="hidden h-5 w-5 dark:block" />
    </button>
    ...
    <div x-show="menu"
        ...
        <button class="flex items-center gap-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
            ...
            @click="systemMode()">
            <x-icons.computer-desktop class="h-5 w-5" />
            System
        </button>
    </div>
</div>
